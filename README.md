...
1. 在 [Releases](https://github.com/peterL1244/AutoExtractor/releases) 下载 `AutoExtractor-v0.1.1-win-x64.zip`。
...
便携版输出到 `artifacts/AutoExtractor-v0.1.1-win-x64`，发布 ZIP 与 SHA-256 清单输出到 `artifacts`。包名由 `Directory.Build.props` 版本生成，更新包保留旧版文件夹。GitHub Actions 在 main 推送和 PR 时测试并打包，版本标签触发 Release 发布。
